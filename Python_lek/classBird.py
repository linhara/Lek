...
BANG_IMG = pygame.image.load(os.path.join("imgs", "Bulletboi.png"))
BANG_IMG = pygame.transform.scale(BANG_IMG, (30, 20))
...
def draw_window(win, bird, pipes, base, score, Bullets):
    win.blit(BG_IMG, (0,0))
